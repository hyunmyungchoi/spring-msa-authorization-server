...
public class EmailOtpController {
    ...
    public ResponseEntity<OtpSendResponse>  sendOtp(@Valid @RequestBody EmailOtpSendRequest request) {
        ...
        OtpSendResponse response = exposeDevOtp
                ? OtpSendResponse.withDevOtp(emailOtpService.getExpiresInSeconds(), otp)
                : OtpSendResponse.withoutDevOtp(emailOtpService.getExpiresInSeconds());
